...
def userpage(username):
    ...
    # for i in e:
    #     eventdate.append(i)
    # elength = len(eventdate)
    #
    # for num in range(elength):
    #     #sameday = eventdate[num]
    #     if (eventdate[num].event_date == eventdate[num+1].event_date):
    #         samedate.append(eventdate[num])
    #         #eventdate.remove(eventdate[num])
    #     elif (eventdate[num].event_date != eventdate[num+1].event_date):
    #         datesort.append(samedate)
    #         samedate.clear()
    # for i, j in enumerate(eventdate[:-1]):
    #     sameday = i.event_date
    #     if (i.event_date == ):
    #         samedate.append(i)
    #         eventdate.remove(i)
    #     elif (i.event_date != sameday):
    #         datesort.append(samedate)
    #         samedate.clear()
